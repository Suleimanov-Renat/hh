        ...
        <div class="row">
            <form action="/cv?action=create" method="get" class="form-horizontal" id="cvform" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10"><input type="text" name="title"  data-required="true" /></div>
                </div>
                <div class="form-group">
                    <label class="col-lg-2 control-label">Текст</label>
                    <div class="col-lg-10"><textarea name="text" ></textarea></div>
                </div>
                <div class="form-group">
                    <label class="col-lg-2 control-label">Образование</label>
                    <div class="col-lg-10"><input type="text" name="education" /></div>
                </div>
                <div class="form-group">
                    <label class="col-lg-2 control-label">Опыт</label>
                    <div class="col-lg-10"><input type="number" name="experience" /></div>
                </div>
